...
- **Security** — has a security scan been run? (vibe-check — the security scan tool in this pack.) Are there known findings?
...
- [ ] **Security** — [note if a security scan was run (vibe-check — the security scan tool in this pack); list known findings]
