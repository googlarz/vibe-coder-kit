...
echo "  During session:   /vibe-scope    /vibe-test     /vibe-guardian"
echo "                    /vibe-auth     /vibe-oops"
echo "  Shipping:         /vibe-check    /vibe-git      /vibe-launch    /vibe-monitor"
echo "                    /vibe-health   /vibe-handoff  /vibe-onboard   /vibe-docs"
echo "                    /vibe-explain"
echo "  Troubleshooting:  /vibe-debug    /vibe-stuck    /vibe-env       /vibe-log"
echo "                    /vibe-rollback /vibe-secret   /vibe-db"
echo "                    /vibe-clean    /vibe-perf     /vibe-upgrade"
echo ""
